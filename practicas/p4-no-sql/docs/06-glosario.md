...
| **mongosh** | *MongoDB Shell* — Shell interactivo oficial de MongoDB, escrito en Node.js. Permite ejecutar comandos y consultas en JavaScript directamente contra la base de datos. Reemplazó al antiguo shell `mongo` desde MongoDB 5.0. Se accede con `mongosh` dentro del contenedor o instalado localmente. |
